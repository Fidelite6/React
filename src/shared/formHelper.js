export const getInputElementConfig = (type, placeholder) => {
    return {
      type,
      placeholder,
    };
...
export const createFormFieldObject = (elementType, elementConfig, value, validation = undefined, validationError = '',) => {
  return {
    elementType,
    elementConfig,
    validation,
...
export const inputChangedHandler = (form, event, inputIdentifier) => {
  const updatedForm = {
    ...form,
    [inputIdentifier]: {
